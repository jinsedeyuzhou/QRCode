...
import com.ebrightmoon.qrcode.core.QRCodeUtil;
import com.ebrightmoon.qrcode.zxing.QRCodeDecoder;
import com.ebrightmoon.qrcode.zxing.QRCodeEncoder;
...
public class TestGeneratectivity extends AppCompatActivity {
    ...
    private void createChineseQRCode() {
        ...
        new AsyncTask<Void, Void, Bitmap>() {
            ...
            protected Bitmap doInBackground(Void... params) {
                return QRCodeEncoder.syncEncodeQRCode("王浩", QRCodeUtil.dp2px(TestGeneratectivity.this, 150));
            }
    ...
    private void createEnglishQRCode() {
        new AsyncTask<Void, Void, Bitmap>() {
            @Override
            protected Bitmap doInBackground(Void... params) {
                return QRCodeEncoder.syncEncodeQRCode("bingoogolapple", QRCodeUtil.dp2px(TestGeneratectivity.this, 150), Color.parseColor("#ff0000"));
            }
    ...
    private void createChineseQRCodeWithLogo() {
        new AsyncTask<Void, Void, Bitmap>() {
            ...
            protected Bitmap doInBackground(Void... params) {
                ...
                return QRCodeEncoder.syncEncodeQRCode("王浩", QRCodeUtil.dp2px(TestGeneratectivity.this, 150), Color.parseColor("#ff0000"), logoBitmap);
            }
    ...
    private void createEnglishQRCodeWithLogo() {
        new AsyncTask<Void, Void, Bitmap>() {
            ...
            protected Bitmap doInBackground(Void... params) {
                Bitmap logoBitmap = BitmapFactory.decodeResource(TestGeneratectivity.this.getResources(), R.mipmap.logo);
                return QRCodeEncoder.syncEncodeQRCode("bingoogolapple", QRCodeUtil.dp2px(TestGeneratectivity.this, 150), Color.BLACK, Color.WHITE,
                        logoBitmap);
            }
    ...
    private void createBarcodeWidthContent() {
        new AsyncTask<Void, Void, Bitmap>() {
            @Override
            protected Bitmap doInBackground(Void... params) {
                int width = QRCodeUtil.dp2px(TestGeneratectivity.this, 150);
                int height = QRCodeUtil.dp2px(TestGeneratectivity.this, 70);
                int textSize = QRCodeUtil.sp2px(TestGeneratectivity.this, 14);
